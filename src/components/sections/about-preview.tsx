            ...
            <div className="relative aspect-square max-w-lg mx-auto">
              ...
              <div className="relative bg-background rounded-3xl p-8 shadow-2xl">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-ksd-blue/10 rounded-2xl p-6 text-center">
                    <div className="text-4xl font-bold text-ksd-blue mb-2">5+</div>
                    <div className="text-sm text-foreground-secondary">Années d&apos;expérience</div>
                  </div>
                  <div className="bg-ksd-orange/10 rounded-2xl p-6 text-center">
                    <div className="text-4xl font-bold text-ksd-orange mb-2">50+</div>
                    <div className="text-sm text-foreground-secondary">Projets livrés</div>
                  </div>
                  <div className="bg-ksd-orange/10 rounded-2xl p-6 text-center">
                    <div className="text-4xl font-bold text-ksd-orange mb-2">30+</div>
                    <div className="text-sm text-foreground-secondary">Clients actifs</div>
                  </div>
                  <div className="bg-ksd-blue/10 rounded-2xl p-6 text-center">
                    <div className="text-4xl font-bold text-ksd-blue mb-2">2</div>
                    <div className="text-sm text-foreground-secondary">Bureaux au Sénégal</div>
                  </div>
                </div>
              </div>
            </div>
