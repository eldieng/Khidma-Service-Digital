  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-background to-background-secondary">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-ksd-orange/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-ksd-blue/10 rounded-full blur-3xl" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-ksd-orange/5 to-ksd-blue/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-20 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-ksd-orange/10 text-ksd-orange text-sm font-medium mb-8"
          >
          ...
          >
            {[
              ...
              <div key={index} className="text-center">
                <div className="text-3xl sm:text-4xl font-bold text-ksd-orange mb-2">
                  {stat.value}
                </div>
